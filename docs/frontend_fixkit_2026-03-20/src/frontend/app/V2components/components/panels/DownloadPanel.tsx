              ...
              {getAvailableFileCount() < getTotalFileCount() && (
                <div className="p-4 bg-slate-900/50 rounded-lg border border-slate-700">
                  ...
                  <p className="text-xs text-slate-400 mb-3">
                    This is normal when a pipeline stage was skipped, is still
                    running, or did not produce output for this video.
                  </p>
                  <ul className="text-xs text-slate-500 space-y-1">
                    <li>• visual or audio modules may not both be enabled</li>
                    <li>• some outputs are optional, including face manifests</li>
                    <li>• processing may still be in progress</li>
                  </ul>
