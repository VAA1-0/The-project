...
export const API_CONFIG = {
  ...
  FILE_TYPES: {
    ...
    mise_en_scene_scene_cards: {
      name: "Mise-en-Scene Scene Card Report",
      extension: ".json",
      icon: "json",
      description: "Evidence-linked scene cards with exact speech, ontology facets, and navigation targets",
      mimeType: "application/json",
      color: "text-lime-400",
    },
    narrative_lens_reading: {
      name: "Narrative Lens Readings",
      extension: ".json",
      icon: "json",
      description: "Source-linked contextual plot readings by Aristotle, Freytag, Campbell, Frye, Booker, and motive lenses",
      mimeType: "application/json",
      color: "text-cyan-400",
    },
    character_path_reading: {
      name: "Character Path Readings",
      extension: ".json",
      icon: "json",
      description: "Source-linked Narrative Agent path readings for scene presence, ranking, archetype tendency, relation, and trajectory",
      mimeType: "application/json",
      color: "text-fuchsia-400",
    },
    datascene_meaning_network: {
      name: "Datascene Meaning Network",
      extension: ".json",
      icon: "json",
      description: "Scene timeline, character presence candidates, person/transcript co-presence, and raw-detection overload diagnostics",
      mimeType: "application/json",
      color: "text-teal-400",
    },
    source_extraction_metadata_summary: {
      name: "Scene Card Source Extraction Metadata Summary",
      extension: ".json",
      icon: "json",
      description: "Separate scene-card-derived extraction summary that does not overwrite source metadata",
      mimeType: "application/json",
      color: "text-teal-400",
    },
    mise_en_scene_scene_card_report_draft_md: {
      name: "Scene Card Report Draft",
      extension: ".md",
      icon: "file",
      description: "Markdown report draft generated from mature scene-card evidence",
