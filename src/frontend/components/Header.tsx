...
export default function Header() {
  ...
  return (
    <div className="cursor-pointer flex flex-col bg-linear-to-br from-slate-900 via-slate-800 to-slate-900 text-slate-100">
      {/* Header */}
        ...
        <div className="max-w-7xl  px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1 px-3.5 py-0.5 flex justify-start items-center gap-2.5">
              <Button
                variant="ghost"
                className="cursor-pointer hover:bg-slate-700/40 transition"
                onClick={handleBack}
              >
                Dashboard
              </Button>
