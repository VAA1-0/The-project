...
Source: "..\run_vaa1.bat"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\src\*"; DestDir: "{app}\src"; Flags: recursesubdirs
Source: "..\logs\*"; DestDir: "{app}\logs"; Flags: recursesubdirs createallsubdirs

[Icons]
Name: "{group}\VAA1"; Filename: "{app}\run_vaa1.bat"; WorkingDir: "{app}"
Name: "{commondesktop}\VAA1"; Filename: "{app}\run_vaa1.bat"; WorkingDir: "{app}"
